...
class Block(nn.Module):
    def __init__(self, in_filters, out_filters, reps, strides=1, start_with_relu=True, grow_first=True):
        ...
        # rep is a sequential layers which will act later
        rep = []
...
class Xception(nn.Module):
    ...
    def __init__(self, num_classes=1000):
        ...
        self.block11 = Block(in_filters=728, out_filters=728, reps=3, strides=1, start_with_relu=True, grow_first=True)

        # Exit flow
        self.block12 = Block(in_filters=728, out_filters=1024, reps=2, strides=2, start_with_relu=True, grow_first=False)
